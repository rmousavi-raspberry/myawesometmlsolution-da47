[myawesometmlsolution-da47] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolution-da47] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolution-da47] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/rmousavi-raspberry/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33703  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='rmousavi-raspberry'  \-\-env DOCKERUSERNAME='rmousavi'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          ...
          --env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypi.git \
...
[myawesometmlsolution-da47] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/rmousavi-raspberry/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolution-da47
...
.. important::
   solution_preprocessing_dag-myawesometmlsolution-da47
...
.. important::
   VIPERHOST_PRODUCE=172.27.0.166, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.27.0.166, VIPERPORT_PREPROCESS=42461, VIPERHOST_PREPOCESS2=172.27.0.166, VIPERPORT_PREPROCESS2=46485, VIPERHOST_PREPOCESS_PGPT=172.27.0.166, VIPERPORT_PREPROCESS_PGPT=34967, VIPERHOST_ML=172.27.0.166, VIPERPORT_ML=45337, VIPERHOST_PREDCT=172.27.0.166, VIPERPORT_PREDICT=41613, HPDEHOST=172.27.0.166, HPDEPORT=38031, HPDEHOST_PREDICT=172.27.0.166, HPDEPORT_PREDICT=37245

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6358-myawesometmlsolution-da47,solution_preprocessing_dag-myawesometmlsolution-da47, python-preprocess-7113-myawesometmlsolution-da47,solution_preprocessing_dag-myawesometmlsolution-da47, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
