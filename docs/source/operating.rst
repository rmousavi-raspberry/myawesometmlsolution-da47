...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37683  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='rmousavi-raspberry'  \-\-env DOCKERUSERNAME='rmousavi'  \-\-env MQTTUSERNAME=''  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   VIPERHOST_PRODUCE=172.27.0.166, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.27.0.166, VIPERPORT_PREPROCESS=40099, VIPERHOST_PREPOCESS2=172.27.0.166, VIPERPORT_PREPROCESS2=36239, VIPERHOST_PREPOCESS_PGPT=172.27.0.166, VIPERPORT_PREPROCESS_PGPT=44159, VIPERHOST_ML=172.27.0.166, VIPERPORT_ML=44901, VIPERHOST_PREDCT=172.27.0.166, VIPERPORT_PREDICT=44625, HPDEHOST=172.27.0.166, HPDEPORT=40447, HPDEHOST_PREDICT=172.27.0.166, HPDEPORT_PREDICT=43277

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7822-myawesometmlsolution-da47,solution_preprocessing_dag-myawesometmlsolution-da47, python-preprocess-6875-myawesometmlsolution-da47,solution_preprocessing_dag-myawesometmlsolution-da47, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
