Scaling [myawesometmlsolution-da47] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolution-da47] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolution-da47.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolution-da47.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolution-da47.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolution-da47.yml

myawesometmlsolution-da47.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolution-da47.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolution-da47.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolution-da47
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolution-da47
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolution-da47
             image: rmousavi/myawesometmlsolution-da47-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'myawesometmlsolution-da47'                              
             - name: SOLUTIONNAME
               value: 'myawesometmlsolution-da47'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolution-da47'
             - name: GITUSERNAME
               value: 'rmousavi-raspberry'
             - name: GITREPOURL
               value: 'https://github.com/rmousavi-raspberry/raspberrypi.git'
             ...
             - name: step4jsoncriteria # STEP 4
               value: 'uid=host.ip,filter:allrecords~subtopics=tags~values=log.syslog.severity.code~identifiers=log.syslog.severity.name~datetime=@timestamp~msgid=~latlong='                           
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolution-da47-visualization-service
       labels:
         app: myawesometmlsolution-da47-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolution-da47 6060:6060

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:6060/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolution-da47.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolution-da47.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolution-da47.yml
...
.. code-block::
   ...
   http://tml.tss/viz/dashboard.html?topic=iot-preprocess&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
